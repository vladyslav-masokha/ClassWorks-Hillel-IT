...
var str = 'Hello Hillel';
console.log(str[1]);
console.log(str.length); // cases
// toUpperCase() - returns new string

console.log('toUpperCase():', str.toUpperCase());
console.log('source: ', str); // toLowerCase() - returns new string

console.log('toLowerCase():', str.toLowerCase());
console.log('source: ', str); // checking
...
console.log('source: ', str); // includes() - return boolean
